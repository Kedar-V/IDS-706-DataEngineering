...
1. [Dataset](#dataset)
2. [Features](#features)
   - [DataFrameLoader](#1-dataframeloader)
   - [CryptoEDA](#2-cryptoeda)
   - [CryptoFeatureEngineer](#3-cryptofeatureengineer)
   - [CryptoDatasetLoader](#4-cryptodatasetloader)
   - [Model Training](#5-model-training)
   - [ModelEvaluator](#6-modelevaluator)
3. [Results](#results)
4. [Improvements and Future Work](#improvements-and-future-work)
5. [Detailed Results and Visualizations](#detailed-results-and-visualizations)
