...
class BitcoinOHLCViewer:
    def __init__(self):
        ...
        self.predictor = Predictor(model_path="/app/Week4/app/model/random_forest_model.pkl")
    ...
    def show_menu(self):
        menu = st.sidebar.radio("Menu", ["Ask Assistant", "Aladin", "Daily News", "Data View"], index=0)
        if menu == "Data View":
