...
from Bitcoin_DataAnalysis import DataFrameLoader, CryptoEDA, CryptoFeatureEngineer, CryptoDatasetLoader, RandomForestRegressor
...
class ModelTrainer:
    ...
    def prepare_dataset(self):
        ...
        self.X_train, self.X_test, self.y_train, self.y_test = dataloader.train_test_split()
